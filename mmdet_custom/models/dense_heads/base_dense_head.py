...
import torch
from mmcv_custom.ops import batched_nms
from mmengine_custom.config import ConfigDict
from mmengine_custom.model import BaseModule, constant_init
from mmengine_custom.structures import InstanceData
from torch import Tensor

from mmdet_custom.structures import SampleList
from mmdet_custom.structures.bbox import (cat_boxes, get_box_tensor, get_box_wh,
                                          scale_boxes)
from mmdet_custom.utils import InstanceList, OptMultiConfig
...
class BaseDenseHead(BaseModule, metaclass=ABCMeta):
    ...
    def _predict_by_feat_single(self,
        ...
        Args:
            ...
            cfg (mmengine_custom.Config): Test / postprocessing configuration,
