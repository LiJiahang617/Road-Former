...
from mmengine_custom.model import BaseModule, constant_init, xavier_init
from mmengine_custom.registry import MODELS
from mmengine_custom.utils import deprecated_api_warning
from torch.autograd.function import Function, once_differentiable

from mmcv_custom.utils import IS_CUDA_AVAILABLE, IS_MLU_AVAILABLE
...
class MultiScaleDeformableAttention(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg: Optional[mmengine_custom.ConfigDict] = None,
