...
from mmseg_custom.registry import VISUALIZERS
from mmseg_custom.structures import SegDataSample
from mmseg_custom.utils import get_classes, get_palette
...
class SegLocalVisualizer(Visualizer):
    ...
    def add_datasample(
            ...
            show: bool = False,
            wait_time: float = 0,
            # TODO: Supported in mmengine_custom's Viusalizer.
        ...
        if out_file is not None:
            mmcv_custom.imwrite(mmcv_custom.bgr2rgb(drawn_img), out_file)
        else:
