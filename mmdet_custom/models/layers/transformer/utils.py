...
from mmcv_custom.cnn import (Linear, build_activation_layer, build_conv_layer,
                             build_norm_layer)
from mmcv_custom.cnn.bricks.drop import Dropout
...
from mmdet_custom.utils import OptConfigType, OptMultiConfig
...
class PatchEmbed(BaseModule):
    ...
    Args:
        ...
        init_cfg (`mmengine_custom.ConfigDict`, optional): The Config for
...
class ConditionalAttention(BaseModule):
    ...
    def __init__(self,
        ...
        First dimension of all DETRs in mmdet_custom is `batch`, \
...
class DynamicConv(BaseModule):
    ...
    Args:
        ...
        norm_cfg (dict): Config dict for normalization layer. Default
            layer normalization.
        init_cfg (obj:`mmengine_custom.ConfigDict`): The Config for initialization.
            Default: None.
    """
