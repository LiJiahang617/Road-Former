...
from mmcv_custom.cnn.bricks.transformer import AdaptivePadding
...
class PatchEmbed(BaseModule):
    ...
    def __init__(self,
        ...
        warnings.warn('The `PatchEmbed` in mmpretrain_custom will be deprecated. '
                      'Please use `mmcv_custom.cnn.bricks.transformer.PatchEmbed`. '
...
class PatchMerging(BaseModule):
    ...
    Modified from mmcv_custom, and this module supports specifying whether to use
    post-norm.
