...
class BaseAveragedModel(nn.Module):
    ...
    In mmengine_custom, we provide two ways to use the model averaging:

    1. Use the model averaging module in hook:
       We provide an :class:`mmengine_custom.hooks.EMAHook` to apply the model
    ...
    2. Use the model averaging module directly in the algorithm. Take the ema
       ...
       >>> from mmengine_custom.model import ExponentialMovingAverage
