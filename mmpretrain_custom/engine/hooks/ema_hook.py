...
from mmengine_custom.hooks import EMAHook as BaseEMAHook
...
class EMAHook(BaseEMAHook):
    ...
    Comparing with :class:`mmengine_custom.hooks.EMAHook`, this hook accepts
    ...
    Args:
        ema_type (str): The type of EMA strategy to use. You can find the
            supported strategies in :mod:`mmengine_custom.model.averaged_model`.
