...
from mmengine_custom.utils import is_str
...
def batch_label_to_onehot(batch_label, split_indices, num_classes):
    ...
    Examples:
        >>> import torch
        >>> from mmpretrain_custom.structures import batch_label_to_onehot
...
def label_to_onehot(label: LABEL_TYPE, num_classes: int):
    ...
    Examples:
        >>> import torch
        >>> from mmpretrain_custom.structures import label_to_onehot
        >>> # Single-label
