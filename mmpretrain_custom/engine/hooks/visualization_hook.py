...
from mmengine_custom.fileio import join_path
from mmengine_custom.hooks import Hook
from mmengine_custom.runner import EpochBasedTrainLoop, Runner
...
class VisualizationHook(Hook):
    ...
    Args:
        ...
        **kwargs: other keyword arguments of
            :meth:`mmpretrain_custom.visualization.UniversalVisualizer.visualize_cls`.
    """
