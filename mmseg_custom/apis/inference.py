...
from mmseg_custom.utils import SampleList, dataset_aliases, get_classes, get_palette
...
def init_model(config: Union[str, Path, Config],
    ...
    init_default_scope(config.get('default_scope', 'mmseg_custom'))
