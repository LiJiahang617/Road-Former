...
from mmpretrain_custom.utils import require
...
def init_empty_weights(include_buffers: bool = False):
    ...
    load checkpoint from `mmengine_custom.runner.load_checkpoint` and
    ...
    import mmengine_custom.runner.checkpoint as mmengine_load
