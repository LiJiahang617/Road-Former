...
from mmengine_custom.device import is_npu_available
...
def all_reduce(data: Tensor,
    ...
    Examples:
        >>> import torch
        >>> import mmengine_custom.dist as dist
...
def collect_results_cpu(result_part: list,
    ...
    if tmpdir is None:
        ...
        if rank == 0:
            mmengine_custom.mkdir_or_exist('.dist_test')
        ...
        mmengine_custom.mkdir_or_exist(tmpdir)
