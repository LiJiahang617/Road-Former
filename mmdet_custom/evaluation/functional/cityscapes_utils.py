...
import mmcv_custom
import numpy as np
from mmengine_custom.fileio import get
...
def readGTImage(image_file: Union[str, Path],
    ...
    img = mmcv_custom.imfrombytes(img_bytes, flag='unchanged', backend='pillow')
    return img
...
def instances2dict(image_list: list,
    ...
    for image_name in image_list:
        ...
        imgNp = mmcv_custom.imfrombytes(img_bytes, flag='unchanged', backend='pillow')
