...
def register_box(name: str,
    ...
    Examples:
        >>> from mmdet_custom.structures.bbox import register_box
        >>> from mmdet_custom.structures.bbox import BaseBoxes
...
def register_box_converter(src_type: Union[str, type],
    ...
    Examples:
        >>> from mmdet_custom.structures.bbox import register_box_converter
        >>> # as a decorator
...
def autocast_box_type(dst_box_type='hbox') -> Callable:
    ...
    It commenly used in mmdet_custom.datasets.transforms to make the transforms up-
