...
from mmcv_custom.transforms import Compose
...
from mmseg_custom.utils import ConfigType, SampleList, get_classes, get_palette
...
class MMSegInferencer(BaseInferencer):
    ...
    Args:
        model (str, optional): Path to the config file or the model name
            defined in metafile. Take the `mmseg_custom metafile <https://github.com/open-mmlab/mmsegmentation/blob/main/configs/fcn/metafile.yaml>`_
        ...
        scope (str, optional): The scope of the model. Defaults to 'mmseg_custom'.
    """ # noqa
    ...
    def postprocess(self,
        ...
        for i, pred in enumerate(preds):
            ...
            if pred_out_dir != '':
                mmengine_custom.mkdir_or_exist(pred_out_dir)
