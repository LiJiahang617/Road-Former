...
from mmengine_custom.model import (BaseDataPreprocessor, ImgDataPreprocessor,
                                   stack_batch)

from mmpretrain_custom.registry import MODELS
from mmpretrain_custom.structures import (DataSample, MultiTaskDataSample,
...
class ClsDataPreprocessor(BaseDataPreprocessor):
    ...
    Comparing with the :class:`mmengine_custom.model.ImgDataPreprocessor`,
    ...
    Args:
        ...
        batch_augments (dict, optional): The batch augmentations settings,
            ...
            :class:`mmpretrain_custom.models.RandomBatchAugment`.
    """
...
class SelfSupDataPreprocessor(ImgDataPreprocessor):
    ...
    Compared with the :class:`mmengine_custom.ImgDataPreprocessor`, this module
    ...
    def forward(
        ...
        # Here is what is different from :class:`mmengine_custom.ImgDataPreprocessor`
