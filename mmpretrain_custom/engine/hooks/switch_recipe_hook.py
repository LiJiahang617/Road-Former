...
from mmpretrain_custom.models.utils import RandomBatchAugment
from mmpretrain_custom.registry import HOOKS, MODEL_WRAPPERS, MODELS
    ...
    Args:
        schedule (list): Every item of the schedule list should be a dict, and
            ...
            - ``batch_augments`` (dict | None, optional): The new batch
              ...
              <mmpretrain_custom.models.utils.batch_augments>` for more details.
