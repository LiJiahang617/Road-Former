...
import torch
from mmengine_custom.utils.dl_utils import collect_env as mmengine_collect_env
...
def collect_env():
    ...
    try:
        from mmcv_custom.ops import get_compiler_version, get_compiling_cuda_version
