...
from mmdet_custom.models.dense_heads import RoadFormerHead as MMDET_RoadFormerHead
...
class RoadFormerHead(MMDET_RoadFormerHead):
    """Implements the RoadFormer head.
    Args:
    ...
    def _seg_data_to_instance_data(self, batch_data_samples: SampleList):
        ...
        to MMDetection to ensure ``MMDET_RoadFormerHead`` could be called
