...
import torch
from mmengine_custom.model import BaseDataPreprocessor
from mmseg_custom.registry import MODELS
from mmseg_custom.utils import stack_batch
@MODELS.register_module()
class SegDataPreProcessor(BaseDataPreprocessor):
    """Image pre-processor for segmentation tasks.
    Comparing with the :class:`mmengine_custom.ImgDataPreprocessor`,
