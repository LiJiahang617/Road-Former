...
from mmengine_custom.runner import EpochBasedTrainLoop, IterBasedTrainLoop, Runner
from mmengine_custom.utils import ProgressBar
...
def update_bn_stats(
    ...
    # get dist info
    rank, world_size = mmengine_custom.dist.get_dist_info()
