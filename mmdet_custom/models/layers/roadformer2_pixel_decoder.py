...
# from mmcv_custom.cnn.bricks.norm import build_norm_layer
...
from mmengine_custom.model import (BaseModule, ModuleList, caffe2_xavier_init,
                                   normal_init, xavier_init,constant_init)
from torch import Tensor
from mmdet_custom.registry import MODELS
from mmdet_custom.utils import ConfigType, MultiConfig, OptConfigType,OptMultiConfig
...
class RoadFormer2PixelDecoder(BaseModule):
    ...
    def __init__(self,
        ...
        #     new_channel = int(in_channels[i] * 1.5)
        #     channel_reduce_conv = nn.Conv2d(new_channel, in_channels[i], kernel_size=1)
        #     c_reduce_convs.append(channel_reduce_conv)
        # self.channel_reduce_convs = ModuleList(c_reduce_convs)
