...
from mmdet_custom.structures.bbox import BaseBoxes, cat_boxes
from mmdet_custom.utils import util_mixins
...
class SamplingResult(util_mixins.NiceRepr):
    ...
    Example:
        ...
        >>> from mmdet_custom.models.task_modules.samplers.sampling_result import *  # NOQA
    ...
    def random(cls, rng=None, **kwargs):
        ...
        from mmdet_custom.models.task_modules.assigners import AssignResult
        from mmdet_custom.models.task_modules.samplers import RandomSampler
        rng = ensure_rng(rng)
