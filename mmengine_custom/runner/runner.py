...
class Runner:
    ...
    def __init__(
        ...
        default_scope: str = 'mmengine_custom',
    ...
    def from_cfg(cls, cfg: ConfigType) -> 'Runner':
        ...
        runner = cls(
            ...
            default_scope=cfg.get('default_scope', 'mmengine_custom'),
    ...
    def build_param_scheduler(
        ...
        Examples:
            ...
            >>> schedulers
            [<mmengine_custom.optim.scheduler.lr_scheduler.MultiStepLR at 0x7f70f6966290>]  # noqa: E501
            ...
            >>> schedulers = runner.build_param_scheduler(scheduler_cfg)
            >>> schedulers
            [<mmengine_custom.optim.scheduler.lr_scheduler.MultiStepLR at 0x7f70f60dd3d0>,  # noqa: E501
            <mmengine_custom.optim.scheduler.lr_scheduler.StepLR at 0x7f70f6eb6150>]
    ...
    def build_dataloader(dataloader: Union[DataLoader, Dict],
        ...
        # However, in mmengine_custom, if `collate_fn` is not defined in
    ...
    def save_checkpoint(
        ...
        Args:
            ...
            file_client_args (dict, optional): Arguments to instantiate a
                FileClient. See :class:`mmengine_custom.fileio.FileClient` for
    ...
    def _check_scheduler_cfg(
        ...
        Examples:
            ...
            >>> from mmengine_custom.optim import MultiStepLR
