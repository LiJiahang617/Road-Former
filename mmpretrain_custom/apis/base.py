...
from mmengine_custom.dataset import default_collate
from mmengine_custom.fileio import get_file_backend
...
class BaseInferencer:
    ...
    2. Forward the data to the model by :meth:`forward`. ``BaseInferencer``
       assumes the model inherits from :class:`mmengine_custom.models.BaseModel` and
