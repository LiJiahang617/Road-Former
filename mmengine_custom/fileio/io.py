...
# mmengine_custom/fileio/handlers/registry_utis. Import them
...
def copyfile_from_local(
    ...
    Examples:
        >>> # dst is a file
        >>> src = '/path/of/file'
        >>> dst = 's3://openmmlab/mmengine_custom/file1'
        >>> # src will be copied to 's3://openmmlab/mmengine_custom/file1'
        >>> copyfile_from_local(src, dst)
        s3://openmmlab/mmengine_custom/file1

        >>> # dst is a directory
        >>> dst = 's3://openmmlab/mmengine_custom'
        >>> # src will be copied to 's3://openmmlab/mmengine_custom/file''
        >>> copyfile_from_local(src, dst)
        's3://openmmlab/mmengine_custom/file'
    """
    backend = get_file_backend(
...
def copytree_from_local(
    ...
    Examples:
        >>> src = '/path/of/dir'
        >>> dst = 's3://openmmlab/mmengine_custom/dir'
        >>> copyfile_from_local(src, dst)
        's3://openmmlab/mmengine_custom/dir'
    """
    backend = get_file_backend(
        dst, backend_args=backend_args, enable_singleton=True)
...
def copyfile_to_local(
    ...
    Examples:
        >>> # dst is a file
        >>> src = 's3://openmmlab/mmengine_custom/file'
        >>> dst = '/path/of/file'
...
def copytree_to_local(
    ...
    Examples:
        >>> src = 's3://openmmlab/mmengine_custom/dir'
        >>> dst = '/path/of/dir'
