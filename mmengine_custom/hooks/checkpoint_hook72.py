...
class CheckpointHook72(Hook):
    ...
    def __init__(self,
        ...
        self.args = kwargs
        self.miou_critical_value = miou_critical_value
    ...
    def _save_best_checkpoint(self, runner, metrics) -> None:
        ...
        for key_indicator, rule in zip(self.key_indicators, self.rules):
            ...
            # Modify here: save checkpoint if key_score is greater than miou_critical_value
            if key_indicator == 'mIoU' and key_score > self.miou_critical_value:
                ckpt_name = f'mIoU_{key_score:0.2f}_{ckpt_filename}'
                runner.save_checkpoint(
                    self.out_dir,
                    filename=ckpt_name,
                ...
                runner.logger.info(
                    f'Checkpoint with {key_score:0.4f} {key_indicator} '
